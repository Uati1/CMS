...
<form method="post" action="">
	<table class="table table-bordered table-hover">
		...
		<div class="col-xs-4">
			...
			<a class="btn btn-primary" href="posts.php?source=add">Add New</a>
		</div>
			...
			<?php
				...
				while($row= mysqli_fetch_assoc($select_posts)){
					...
					echo "<tr>";
						...
						echo "<td><a href='posts.php?source=edit&p_id={$id}'>Edit</a></td>";
						echo "<td><a onClick=\"javascript: return confirm('Are you sure you wat to delete ?'); \" href='posts.php?delete={$id}'>delete</a></td>";
					echo "</tr>";
				}
