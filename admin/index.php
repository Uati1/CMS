        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Welcome to admin <?php if(isset($_SESSION['username'])){echo $_SESSION['username'];} ?>
				...
				<?php
					...
					$query = "SELECT * FROM users WHERE us_role = 'subscriber' ";
						  ...
						  function drawChart() {
							var data = google.visualization.arrayToDataTable([
							  ...
							  <?php 
								...
								$elements = ['All Posts', 'Active Posts', 'Draft Posts', 'Comments', 'Disapproved', 'Users', 'Subscribers', 'Categories'];
